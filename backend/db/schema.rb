...
ActiveRecord::Schema.define(version: 2020_03_22_074036) do
  ...
  create_table "deployment_versions", force: :cascade do |t|
    t.string "version"
    t.bigint "deployment_id", null: false
    t.bigint "service_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["deployment_id"], name: "index_deployment_versions_on_deployment_id"
    t.index ["service_id"], name: "index_deployment_versions_on_service_id"
  end
  ...
  add_foreign_key "deployment_versions", "deployments"
  add_foreign_key "deployment_versions", "services"
